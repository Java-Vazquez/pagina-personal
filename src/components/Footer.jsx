          ...
          <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
              ...
              <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                    <li class="mb-4">
                      <a href="https://github.com/Java-Vazquez/Busqueda_grafos_1#busqueda_grafos_1" class="hover:underline hover:text-[#49AF73]">Uninformed search</a>
                    </li>
                    <li class="mb-4">
                      <a href="https://github.com/Java-Vazquez/vision-computadora" class="hover:underline hover:text-[#49AF73]">Computer vision</a>
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                    <li class="mb-4">
                      <a href="https://www.linkedin.com/in/javier-v%C3%A1zquez-gurrola-01615b241/" class="hover:underline hover:text-[#49AF73] ">LinkedIn</a>
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                    ...
                    <li>
                      <a href="https://github.com/Java-Vazquez" class="hover:underline hover:text-pink-600">Github</a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
              ...
              <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                <a href="https://www.linkedin.com/in/javier-v%C3%A1zquez-gurrola-01615b241/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
