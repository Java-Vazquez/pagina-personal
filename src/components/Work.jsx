    ...
    return (
        <div name='work' className='w-full lg:h-screen text-[#F8FBFF] bg-[#1C1C1D]'>
                        ...
                        <div className='px-3 opacity-0 group-hover:opacity-100'>
                            ...
                            <div className='pt-8 text-center'>
                                <a href="" target="_blank">
                                    <button onClick={openModal} className='text-center rounded-lg  bg-[#F8FBFF] text-gray-700 font-bold button-div hover:bg-[#1C1C1D] hover:text-[#F8FBFF]'>
                                        Demo
                                    </button>
                                </a>
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal}>
                <p className='text-md font-bold inline border-b-4 text-[#F8FBFF] border-green-500'>Opps... still working on that  </p>
            </Modal>
        </div>
